...
import { getNowPlayingMovies } from '@/app/lib/api/tmdb';
...
export default function NowPlayingPage() {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <h1 className="text-3xl font-bold mb-2">Now Playing in Theaters</h1>
            <p className="text-gray-400 mb-8">Latest movies currently in cinemas</p>
