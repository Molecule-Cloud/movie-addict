    ...
    <>
      <div className='space-y-12'>
        <section className='text-center'>
          ...
          <p className='text-xl text-white max-w-2xl mx-auto'>Discover, save, and explore your favorite movies. Your personal <span className='text-yellow-300'>cinema companion</span> for finding the perfect film.</p>
        </section>
